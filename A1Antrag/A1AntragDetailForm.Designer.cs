...
partial class A1AntragDetailForm
{
    ...
    private static DateEdit BuildDate(int x, int y, int w)
    {
        ...
        d.Properties.EditFormat.FormatType      = FormatType.DateTime;
        d.Properties.EditFormat.FormatString    = "dd.MM.yyyy";
        d.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
        d.Properties.CalendarView  = DevExpress.XtraEditors.Repository.CalendarView.Classic;
        d.Properties.ShowToday     = true;
        d.Properties.ShowClear     = false;
